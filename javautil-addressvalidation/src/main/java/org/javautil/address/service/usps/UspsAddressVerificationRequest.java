 ...
 */
public class UspsAddressVerificationRequest implements AddressValidator {
	 ...
	 */
	public UspsAddressVerificationRequest() {
	 ...
	 */
	public UspsAddressVerificationRequest(final String url, final String userId) {
		if (url == null) {
